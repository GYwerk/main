$(function () {
    var $btn = $('#problembtn input');
    var $div = $('#problemcon div');
    $btn.click(function () {
        $(this).addClass('current').siblings().removeClass('current');
        $('#problemcon .item').eq($(this).index()).addClass('active').siblings('.item').removeClass('active');
    })
})

$(function(){
    var problemSubmitRank = echarts.init(document.getElementById('problemSubmitRank'));
    var maxCount = 300;
    var submitCount = [30,42,67,81,86,94,166,220,249,262];
    var submitProblemName = ["三角形判断","部分排序","字符串查找","世界杯排名","温度转换","计算球体重量","阶梯电价计费","计算某月天数","计算整数各位数字之和","完数"];
    ...
    problemSubmitRank.setOption(option);


    var problemPassRateRank = echarts.init(document.getElementById('problemPassRateRank'));
    var passRateProblemName = ['三角形判断', '部分排序', '字符串查找', '世界杯排名', '温度转换'];
    var passRate = [89,86,75,73,70];
    labelTop = {
        normal : {
            label : {
                show : true,
    ...
    option = {
        legend: {
            x : 'center',
            y : 'center',
            data:passRateProblemName
        },
        title : {
            text: '题目通过率最高Top5',
            x: '2%',
            y: '5%',
            textStyle:{color:"#b0252a",fontSize:"30"},
            x: 'center'
        },
        toolbox: {
            show : true,
       ...
       series : [
            {
                ...
                data : [
                    {name:'other', value:100-passRate[0], itemStyle : labelBottom},
                    {name:passRateProblemName[0], value:passRate[0],itemStyle : labelTop}
                ]
            },
            {
                type : 'pie',
                ...
                itemStyle : labelFromatter,
                data : [
                    {name:'other', value:100-passRate[1], itemStyle : labelBottom},
                    {name:passRateProblemName[1], value:passRate[1],itemStyle : labelTop}
                ]
            },
            {
                type : 'pie',
                ...
                itemStyle : labelFromatter,
                data : [
                    {name:'other', value:100-passRate[2], itemStyle : labelBottom},
                    {name:passRateProblemName[2], value:passRate[2],itemStyle : labelTop}
                ]
            },
            {
                type : 'pie',
                ...
                itemStyle : labelFromatter,
                data : [
                    {name:'other', value:100-passRate[3], itemStyle : labelBottom},
                    {name:passRateProblemName[3], value:passRate[3],itemStyle : labelTop}
                ]
            },
            {
                type : 'pie',
                ...
                itemStyle : labelFromatter,
                data : [
                    {name:'other', value:100-passRate[4], itemStyle : labelBottom},
                    {name:passRateProblemName[4], value:passRate[4],itemStyle : labelTop}
                ]
            }
            
        ]
    };
    problemPassRateRank.setOption(option);
})